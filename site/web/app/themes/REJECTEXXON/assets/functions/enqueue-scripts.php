...
function site_scripts() {
  global $wp_styles; // Call global $wp_styles variable to add conditional wrapper around ie stylesheet the WordPress way
    ...
    wp_enqueue_style( 'vegas-css', get_template_directory_uri() . '/assets/css/vegas.min.css', array(), '', 'all' );

    // Vegas JS
    wp_enqueue_script( 'vegas-js', get_template_directory_uri() . '/assets/js/vegas.min.js', array( 'jquery' ), '', true );
